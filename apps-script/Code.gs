...
const SCHEMA = {
  ...
  materials: ["id", "createdAt", "createdBy", "projectId", "siteId", "date", "name", "deliveryNo", "spec", "concreteClass", "diameter", "pourArea", "quantity", "unit", "supplier", "unitPrice", "total", "status", "notes"],
